# -*- coding: utf-8 -*-
"""
Created on Wed Feb 03 14:18:12 2016
...
folder='\\\\foe-data-09.leeds.ac.uk\\a86\\shared\\Alex\\Feldspar Poisson errors\\Extra\\'
folder='/nfs/a86/shared/Alex/Feldspar Poisson errors/Extra/'
...
while True:
    ...
    #print a_old
    if starting==1:
        new_files=[f for f in a]
        starting=0
    else:
        new_files=list(set(a)-set(a_old))
    #print new_files
...
#        print getpwuid(stat(file_name).st_uid).pw_name
        ...
        np.savetxt('poisson_errors_%s.csv'%file_name[4:-4],final_data,fmt='%.6f',delimiter=',',header='Fraction frozen, Temperature, ns,ns_upper,ns_lower, A=%.6f,std=%.6f'%(mu,sigma))
        print 'final file saved', file_name
